    ...
    super::with_entity(&clang, source, |e| {
        ...
        assert_eq!(
            ...
            CommentChild::BlockCommand(BlockCommand {
                command: "brief".into(),
                arguments: vec![],
                children: vec![CommentChild::Text(" This is a function.".into()),]
            })
        );
        assert_eq!(
            children[2],
        ...
        assert_eq!(
            ...
            CommentChild::Paragraph(vec![
                ...
                CommentChild::HtmlStartTag(HtmlStartTag {
                    name: "a".into(),
                    attributes: vec![("href".into(), "http://example.com".into())],
                    closing: false
                }),
        ...
        assert_eq!(
            ...
            CommentChild::TParamCommand(TParamCommand {
                ...
                children: vec![
                    CommentChild::Text(
                        " This template parameter doesn't actually do anything.".into()
                    ),
                    CommentChild::Text(" ".into()),
                ]
            })
        ...
        assert_eq!(
            ...
            CommentChild::ParamCommand(ParamCommand {
                ...
                children: vec![CommentChild::Text(
                    " This parameter alters the behavior of the function in some way.".into()
                ),]
            })
        );
        assert_eq!(
        ...
        assert_eq!(
            children[8],
            CommentChild::VerbatimCommand(vec![" *nullptr ".into()])
        );
    });
}
